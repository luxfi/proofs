...
% main results are 7.5, 7.6, 7.7, 7.8, matching the LP-105 paper numbering.
% (Theorems 7.1--7.4 live in LP-105 itself.)
...
results with theorem numbers aligned to LP-105:
...
\begin{definition}[Certificate subject -- Def.~6.1 of LP-105]
\label{def:subject}
...
\begin{definition}[QuasarCert -- Def.~6.2 of LP-105]
\label{def:cert}
...
once posted.  This is the LP-105 Section~6.4 ``epoch ZK landing''
...
``post-quantum SNARK swap'' in LP-105 \S11 and is out of scope for 3.0
final.
\end{proof}
...
\bibitem{lp105} ``LP-105: Quasar Consensus,'' Lux Industries, 2025.
...
$n = 21$.  This is the figure used in the main text and in LP-105
...
tracked as a future-work item under LP-105 \S11.
...
LP-105 \S11; not in 3.0 final scope.
