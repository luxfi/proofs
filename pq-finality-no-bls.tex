...
\author{Lux Industries Research}
\date{2026-04-13}
...
Ringtail and ML-DSA lattice signatures for ``defense in depth.'' We show
...
and $\mathsf{Ringtail}$ (Ring-LWE threshold) — two independent lattice
assumptions, each post-quantum. The result is operationally simpler,
...
\begin{enumerate}
  \item the reduced three-layer Quasar cert: per-block committee cert,
        per-epoch Ringtail aggregate, per-era Z-chain ZK proof;
